...
description: "Create screenshot previews using colorful backgrounds, 3d orientation, browser frames, and more."
year: 2023
img: "https://res.cloudinary.com/dxgbphyhg/image/upload/q_64/v1687394952/portfolio%20assets/shotsandbox/shotsandbox_3_yczzw1.webp"
github: "https://github.com/jacobschwantes/shotsandbox"
live: "https://www.shotsandbox.com/"
---

<Image src="https://res.cloudinary.com/dxgbphyhg/image/upload/q_64/v1687458173/portfolio%20assets/shotsandbox/app.shotsandbox.com__2_ios7cl.webp" />
<Card>
  # Details
  <Grid cols="2">
    <Block>
      ## Problem 
      When I was looking to showcase my projects on my portfolio,
      I found that the market lacked an intuitive and easily accessible tool for
    ...
    <Block>
      ...
      Furthermore, the solution needed to offer a way to save or export projects without
      demanding user account creation.
    </Block>
  </Grid>
</Card>
<Image src="https://res.cloudinary.com/dxgbphyhg/image/upload/q_64/v1687458173/portfolio%20assets/shotsandbox/app.shotsandbox.com__iiwu01.webp" />
<Card>
  # Process
  <Grid cols="2">
    <Block>
      ...
      platform to be user-friendly, cross-platform, feature-rich, and affordable while also
...
<Image src="https://res.cloudinary.com/dxgbphyhg/image/upload/q_64/v1687458174/portfolio%20assets/shotsandbox/www.shotsandbox.com__1_vhyuma.webp" />
<Card>
  # Conclusion
  <Grid cols="2">
    <Block>
      ...
      Dexie.js, an IndexedDB wrapper library to facilitate anonymous project storage in the browser. A
      careful selection of features was made to avoid overwhelming users while
      still offering high-level functionality, like adding custom gradient
      backgrounds, browser frames, captions, and more.
    </Block>
    <Block>
      ## Final Thoughts 
