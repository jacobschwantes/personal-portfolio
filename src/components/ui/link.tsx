...
const CustomLink: NextComponentType<NextPageContext, {}, CustomLinkProps> = ({
  ...
  <Link
    className="whitespace-pre  dark:text-zinc-400 group flex items-center dark:hover:text-zinc-200 transition-all duration-300 text-zinc-700 hover:text-zinc-950 py-0.5"
    href={href}
  >
